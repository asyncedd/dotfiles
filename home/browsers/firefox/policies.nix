{ ... }:
{
  programs.firefox.policies = {
    ...
    Extensions = {
      ...
      Install = [
        "https://addons.mozilla.org/firefox/downloads/file/4290466/ublock_origin-1.58.0.xpi" # Ublock origin
        ...
        "https://addons.mozilla.org/firefox/downloads/file/4269135/enhancer_for_youtube-2.0.124.2.xpi" # enahcner for youtube
      ];
    };
    SearchEngines = {
      Remove = [
